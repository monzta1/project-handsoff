...
```bash
python3 -m pip install https://github.com/monzta1/project-handsoff/releases/download/v0.3.79/project_handsoff-0.3.79-py3-none-any.whl
...
`worker_count`, per-shard progress, and any serial `fallback_reason`.
