...
security and bug-fix releases within the same minor line. Pass `--pin v0.3.16` only
...
```bash
handsoff upgrade /absolute/path/to/project --to v0.3.16 --dry-run
handsoff upgrade /absolute/path/to/project --to v0.3.16
```

Replace `v0.3.16` with the release being installed.
