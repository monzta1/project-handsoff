...
"$HOME/.local/share/handsoff/venv/bin/python" -m pip install \
  "https://github.com/monzta1/project-handsoff/releases/download/v0.3.35/project_handsoff-0.3.35-py3-none-any.whl"
...
security and bug-fix releases within the same minor line. Pass `--pin v0.3.35` only
...
```bash
handsoff upgrade /absolute/path/to/project --to v0.3.35 --dry-run
handsoff upgrade /absolute/path/to/project --to v0.3.35
```
