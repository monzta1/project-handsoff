...
"$HOME/.local/share/handsoff/venv/bin/python" -m pip install \
  "https://github.com/monzta1/project-handsoff/releases/download/v0.3.27/project_handsoff-0.3.27-py3-none-any.whl"
...
security and bug-fix releases within the same minor line. Pass `--pin v0.3.27` only
...
```bash
handsoff upgrade /absolute/path/to/project --to v0.3.27 --dry-run
handsoff upgrade /absolute/path/to/project --to v0.3.27
```

Replace `v0.3.27` with the release being installed. Instruction files that a
