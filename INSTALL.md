...
security and bug-fix releases within the same minor line. Pass `--pin v0.3.10` only
...
```bash
handsoff upgrade /absolute/path/to/project --to v0.3.10 --dry-run
handsoff upgrade /absolute/path/to/project --to v0.3.10
```

Replace `v0.3.10` with the release being installed.
...
"$HOME/.local/share/handsoff/venv/bin/python" -m pip install --force-reinstall \
  "https://github.com/monzta1/project-handsoff/releases/download/v0.3.9/project_handsoff-0.3.9-py3-none-any.whl"
